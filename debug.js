		...
		async function saveTable(table, data) {
			try {
				//  PROTECCIÓN: Validar que no se intente guardar array vacío en tablas críticas
		...
		async function exportData() {
			...
			a.href = url; a.download = 'codexis_data.json'; a.click();
				...
				if (match) {
					try {
						...
						if (data.type === 'whatsapp_contact') {
							...
							const phone = data.phone || '573174190562';
